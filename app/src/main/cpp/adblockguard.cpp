...
// ConnectivityManager.getLinkProperties(...).dnsServers di sisi Kotlin
// (lihat AdBlockDetector.kt) — file ini HANYA mencocokkan, tidak pernah
// membaca konfigurasi jaringan sendiri secara langsung.
extern "C" JNIEXPORT jboolean JNICALL
